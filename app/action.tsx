    ...
    messages: [
      {
        role: "system",
        content: `
          You are an informed judge that settles debates. Take in the argument and the opposition and return which side is correct in JSON.
           The JSON schema should include:
          {
            "arguement": "true or false",
      ...
      },
      {
        role: "user",
        content: `
          - The arguement is "${userMessage}" and or the opposition is "${OpuserMessage}"" `,
      },
    ],
